...
export function RolesTable() {
  ...
  // //                       <span
  // //                         key={perm.id}
  // //                         className="inline-flex items-center rounded-md bg-emerald-50 px-2 py-0.5 text-[11px] font-medium text-emerald-700 ring-1 ring-inset ring-emerald-600/20 dark:bg-emerald-400/10 dark:text-emerald-400"
  // //                       >
  // //                         {perm.action}
  // //                       </span>
  // //                     ))}
